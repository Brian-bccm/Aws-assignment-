            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <table class="tbl-full">
                    ...
                    <div class="action-submit">
                        ...
                        <input type="submit" name="submit" value="Update Admin" class="btn-admin btn-secondary">
                    </div>
            </form>
        </div>
    </div>
...
if (isset($_POST['submit'])) {
    ...
    if ($update_result) {
        if (!empty($existing_img) && file_exists("../img/admin/" . $existing_img)) {
            unlink("../img/admin/" . $existing_img);
        }

        $_SESSION['admin-update'] = "<h2 class='success'>Admin Updated Successfully!!!</h2>";
        header('location: manage-admin.php');
    } else {
