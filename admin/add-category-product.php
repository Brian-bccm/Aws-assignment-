...
<main>
    ...
    if (isset($_SESSION['delete-category-product'])) {
        echo $_SESSION['delete-category-product'];
        unset($_SESSION['delete-category-product']);
    }
    ?>
    <div class="wrapper">
                        ...
                        while ($row = mysqli_fetch_assoc($result2)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="delete-category-product.php?id=<?php echo $row['id'] ?>"
                                        class="btn-admin btn-danger">Delete Category</a>
                                </td>
                            </tr>
                            <?php
                        }
