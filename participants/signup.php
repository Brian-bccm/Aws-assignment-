    ...
    <section class="login-page">
        <div class="login-wrapper">
            <div class="login">
                <a href="login.php">
                    <div class="back-home">
                        <img src="http://awsgraduatebucket.s3-website-us-east-1.amazonaws.com/img/left.png" alt=""><p>Back</p>
                    </div>
                </a>
                ...
                <form class="form text-center" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <input class="input1" type="password" name="confirm_password" id="confirm_password" placeholder="Confirm Password">
...
if(isset($_POST['submit']))
{
    ...
    {
        $img = "http://awsgraduatebucket.s3-website-us-east-1.amazonaws.com/img/default-user-profile.jpg";
    }
    ...
    $pwd = md5($password);
    $sql = "INSERT INTO tbl_user (fullname, username, email, phone_number, password, img) 
            VALUES ('$fullname', '$username', '$email', '$phone_number', '$pwd', '$img')"; // Replace '$img_path' with actual image path after upload
